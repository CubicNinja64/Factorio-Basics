data:extend({
  ...
  },
  {
    type = "radar",
    name = "sv-radar",
    icon = "__FactorioBasics-Core__/graphics/icons/sv-radar.png",
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "sv-radar"},
    max_health = 300,
    corpse = "big-remnants",
    resistances =
    {
    ...
    max_distance_of_sector_revealed = 24,
    max_distance_of_nearby_sector_revealed = 24,
    energy_per_nearby_scan = "150kJ",
    energy_source =
    {
      type = "electric",
      usage_priority = "secondary-input"
    ...
    pictures =
    {
      filename = "__FactorioBasics-Core__/graphics/entity/machine/sv-radar.png",
      priority = "low",
      width = 153,
      height = 131,
      apply_projection = false,
